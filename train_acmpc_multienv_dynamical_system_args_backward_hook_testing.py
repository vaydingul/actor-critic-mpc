...
if __name__ == "__main__":
    ...
    argprs.add_argument("--n_steps", type=int, default=10)
    argprs.add_argument("--batch_size", type=int, default=5)
    ...
    argprs.add_argument("--total_timesteps", type=int, default=100)
